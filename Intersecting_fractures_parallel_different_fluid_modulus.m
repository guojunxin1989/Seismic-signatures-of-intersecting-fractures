...
con=4*10^(-10);%fracture connectivity,dimensionless
con=con*c/vis;

KfN=[0.0001,1,2,3];%bulk modulus of the fluid
CK=length(KfN);
...
legend('{\itK_{f}} = 0 GPa','{\itK_{f}} = 1 GPa','{\itK_{f}} = 2 GPa','{\itK_{f}} = 3 GPa');
xlim([0.01 100000]);
