...
v(AI,FI)=(2*pi*ft)/real(keff);
inQ(AI,FI)=2*imag(keff)/real(keff);
...
figure(1)
plot(Ang,v(:,1)','r','linewidth',1.3);
hold on;
plot(Ang,v(:,2)','g','linewidth',1.3);
hold on;
plot(Ang,v(:,3)','b','linewidth',1.3);
...
figure(2)
plot(Ang,inQ(:,1),'r','linewidth',1.3);
hold on;
plot(Ang,inQ(:,2),'g','linewidth',1.3);
hold on;
plot(Ang,inQ(:,3),'b','linewidth',1.3);
