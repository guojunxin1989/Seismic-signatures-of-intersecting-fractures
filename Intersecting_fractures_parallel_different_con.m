...
conaN=[0 1 2 4 40 400 4000]*10^(-10);%dimensionless
conN=conaN*c/vis;
CN=length(conN);
...
con=conN(CI);%fracture connectivity, m/(GPa*s)
...
legend('\alpha = 0*10^{-10}','\alpha = 1*10^{-10}','\alpha = 2*10^{-10}','\alpha = 4*10^{-10}','\alpha = 4*10^{-9}','\alpha = 4*10^{-8}');
xlim([0.01 100000]);
